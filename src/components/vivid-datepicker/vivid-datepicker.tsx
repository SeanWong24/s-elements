...
@Component({
  tag: 'vivid-datepicker',
  styleUrl: 'vivid-datepicker.css',
  shadow: true,
})
export class VividDatepicker implements ComponentInterface {

  @Element() hostElement: HTMLVividDatepickerElement;
